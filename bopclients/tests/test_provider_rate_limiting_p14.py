...
class TestSchema005MigrationP14:
    ...
    def test_migration_from_004_to_005_sqlite(self):
        ...
        assert new_ver == "20260902_005"
        assert DatabaseMigrator.get_current_version(db) == "20260902_005"
